  ...
  "inline-flex items-center border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 font-mono uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-success/20 text-success border-success/50",
        warning: "border-transparent bg-warning/20 text-warning border-warning/50",
        info: "border-transparent bg-primary/20 text-primary border-primary/50",
      },
    },
    defaultVariants: {
      variant: "default",
